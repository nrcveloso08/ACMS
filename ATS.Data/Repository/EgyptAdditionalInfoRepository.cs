...
{
    public interface IEgyptAdditionalInfoRepository
    {
    ...
    public class EgyptAdditionalInfoRepository : IEgyptAdditionalInfoRepository
    {
        private readonly IWebServiceHelper _webServiceHelper;

        public EgyptAdditionalInfoRepository(IWebServiceHelper webServiceHelper)
        {
