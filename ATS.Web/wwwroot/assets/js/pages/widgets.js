...
var KTWidgets = function () {
    ...
    var _initApplicantOverview = function () {
        var element = document.getElementById("kt_applicant_overview_chart");
        if (!element) {
            console.warn("⚠️ Applicant Overview element not found.");
            return;
        }

        console.log("✅ Applicant Overview Chart initializing...");
        ...
        var options = {
            series: [
                { name: 'Hired', data: [5, 10, 15, 8, 12, 14, 10] },
                { name: 'Pending', data: [8, 12, 10, 14, 9, 11, 13] },
                { name: 'Rejected', data: [2, 4, 3, 5, 6, 4, 3] }
            ],
            chart: {
                type: 'area',
                height: 350,
            ...
            fill: {
                type: 'gradient',
                gradient: { shadeIntensity: 1, opacityFrom: 0.45, opacityTo: 0.05, stops: [25, 90, 100] }
            },
            colors: [
            ...
            legend: { position: 'top' },
            tooltip: { y: { formatter: val => `${val} Applicants` } }
        };

        // Delay render until container is visible
        const render = () => {
